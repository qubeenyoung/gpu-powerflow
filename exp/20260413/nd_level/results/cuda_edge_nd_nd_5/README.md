# Benchmark Run `cuda_edge_nd_nd_5`
...
- Benchmark binaries: `{'end2end': '/workspace/exp/20260413/nd_level/build/nd_5/end2end/benchmarks/cupf_case_benchmark', 'operators': '/workspace/exp/20260413/nd_level/build/nd_5/operators/benchmarks/cupf_case_benchmark'}`
- Profiles: cuda_edge
