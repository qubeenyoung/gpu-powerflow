# Benchmark Run `matpower_cuda_mixed_edge_operators_r10`
...
- Benchmark binaries: `{'operators': '/workspace/gpu-powerflow/exp/20260428/build/operators-cudss-mt-auto/benchmarks/cupf_case_benchmark'}`
- Profiles: cuda_edge
- Batch size: 1
