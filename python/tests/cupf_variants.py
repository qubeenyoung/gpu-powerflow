...
BASE_CUPF_VARIANTS: list[dict[str, Any]] = [
    ...
    {
        "variant": "cupf-custom-fp64",
        "backend": "cuda",
        "compute": "fp64",
        "cpu_linear_solver": "klu",
        "cuda_jacobian": "edge",
        "cuda_linear_solver": "custom",
        "custom_precision": "fp64",
        "custom_serial_nd": True,
        "custom_seed": 49,
    ...
    {
        "variant": "cupf-custom-fp32",
        "backend": "cuda",
        "compute": "mixed",
        "cpu_linear_solver": "klu",
        "cuda_jacobian": "edge",
        "cuda_linear_solver": "custom",
        "custom_precision": "fp32",
        "custom_serial_nd": True,
        "custom_seed": 49,
        "linear_solver": "custom",
        "jacobian": "edge",
    ...
    {
        "variant": "cupf-custom-tf32",
        "backend": "cuda",
        "compute": "mixed",
        "cpu_linear_solver": "klu",
        "cuda_jacobian": "edge",
        "cuda_linear_solver": "custom",
        "custom_precision": "tf32",
        "custom_serial_nd": True,
        "custom_seed": 49,
        "custom_ozaki": "tc2_first_order",
        "linear_solver": "custom",
        "jacobian": "edge",
        "build_key": "gpu-custom",
        "requires_gpu": True,
