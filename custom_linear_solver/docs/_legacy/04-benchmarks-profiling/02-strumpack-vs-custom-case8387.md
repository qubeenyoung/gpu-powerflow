...
[`../01-orientation/03-lineage-strumpack.md`](../01-orientation/03-lineage-strumpack.md)에서 정리한 대로 STRUMPACK과 `custom_linear_solver`는 **둘 다 multifrontal LU** 패밀리다 (METIS ND, elimination tree, supernode amalgamation, front + extend-add). 같은 알고리즘 패밀리인데 전력망 야코비안 case8387pegase (n=14908, nnz=110572)에서 NR steady-state 성능:
...
|---|---:|---:|---:|---:|
| 1–16 (small) | **7,136** | **96.2%** | 53.0% | 19.1% |
...
평면 망 (power):   separator ~ √N        →  small fronts (수십 단위)
