...
runs (RTX 3090, sm_86, B=64–128; see `fp32-batched-factor-solve-optimization.md` and
`fsa-optimization-report.md`). Where the literature is silent I say so explicitly.
