...
| factorize(4-tier) | `src/factorize/{small,mid,big,large}.cuh`, `factorize.cu` |
...
| **mid** | 33–64 | front 전체를 shared 에 올려 제자리 분해 | **점유 교차점(64)** — whole-front staging 이 `fsz²` 라 넘으면 SM 당 블록 급감 |
