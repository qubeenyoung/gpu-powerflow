...
runs (RTX 3090, sm_86, B=64–128; see `fp32-batched-kernel-optimization.md` and
`factor-solve-analyze-optimization.md`). Where the literature is silent I say so explicitly.
