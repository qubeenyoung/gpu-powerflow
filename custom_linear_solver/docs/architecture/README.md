...
| 05 | [`05-front-tiers.md`](05-front-tiers.md) | `ClassifyFrontTier` 경계(small|mid=32, mid|big=64 fp64/128 float)와 근거, tier→커널 매핑, staging 상한 | 상세 |
...
- **3-tier**: front 크기 함수로 결정적 라우팅 — small(≤32) / mid(≤64 fp64·≤128 float) / big(그 외). [05](05-front-tiers.md).
