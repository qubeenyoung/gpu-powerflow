...
- **analyze**는 작은/중간 case (≤25K)에서 custom 강세 (case1197~case6468rte 5-10× 빠름); 25K 부근에서 close, 두 최대 case에서 cuDSS로 flip. cuDSS setup은 reordering + symbolic factorization이 small matrix에서 더 무거움.
