...
// =======================================================================================
//
// The bottom etree levels (tens of thousands of small fronts) dominate the batched solve the
...
// fronts_per_warp = 32/sub_group_size fronts pack per warp (same small-front-packing idea as factor_small). sub_group_size=32 is the
