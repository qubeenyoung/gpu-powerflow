...
//   max_panel_width              - panel cap hint (analyze may override for large n)
//   float_front            - true if the factor/solve front is float (FP32/TC/TF32); controls
//                            whether float scratch arenas (d_frontf, d_yf) get allocated
//   forced_panels          - optional caller-supplied panel partition (else built here)
//   emit_info              - if true, print front-size and subtree summary to stderr
MultifrontalPlan analyze_multifrontal(int n, int nnz_a, const int* d_Ap, const int* d_Ai,
                                      ...
                                      bool float_front, bool emit_info = false);
